      SUBROUTINE DLOCY(ARG,M,XI,PHIL,DISA,DVARA,DTEMP,DVARH,TETA,Q,IJK,
	...
	DIMENSION dCHA(100,NSOL,9),dE(9),BY(1710),TRANSP(13)  !!!aout04
...
c      WRITE(66,*)' COSTT  SINTT=',COSTT,SINTT
      ...
      CALL BR(ARG,M,PHIL,Q,DISA,DVARA,DTEMP, 2,1,
     *        SINT,COST,SINTT,COSTT,NXI,NBRXI)
      CALL BR(ARG,M,PHIL,Q,DISA,DVARA,DTEMP, 1,2,
     *        SINT,COST,SINTT,COSTT,NXI,NBRXI)
      CALL BR(ARG,M,PHIL,Q,DISA,DVARA,DTEMP,29,3,
     *        SINT,COST,SINTT,COSTT,NXI,NBRXI)
      CALL BR(ARG,M,PHIL,Q,DISA,DVARA,DTEMP,25,4,
     *        SINT,COST,SINTT,COSTT,NXI,NBRXI)
      CALL BR(ARG,M,PHIL,Q,DISA,DVARA,DTEMP,27,5,
     *        SINT,COST,SINTT,COSTT,NXI,NBRXI)
      CALL BR(ARG,M,PHIL,Q,DISA,DVARA,DTEMP,24,6,
     *        SINT,COST,SINTT,COSTT,NXI,NBRXI)
      CALL BR(ARG,M,PHIL,Q,DISA,DVARA,DTEMP,26,7,
     *        SINT,COST,SINTT,COSTT,NXI,NBRXI)
      CALL BR(ARG,M,PHIL,Q,DISA,DVARA,DTEMP, 3,8,
     *        SINT,COST,SINTT,COSTT,NXI,NBRXI)
      CALL BR(ARG,M,PHIL,Q,DISA,DVARA,DTEMP,35,9,
     *        SINT,COST,SINTT,COSTT,NXI,NBRXI)
      CALL BR(ARG,M,PHIL,Q,DISA,DVARA,DTEMP,38,10,
     *        SINT,COST,SINTT,COSTT,NXI,NBRXI)
      CALL BR(ARG,M,PHIL,Q,DISA,DVARA,DTEMP,31,11,
     *        SINT,COST,SINTT,COSTT,NXI,NBRXI)
      CALL BR(ARG,M,PHIL,Q,DISA,DVARA,DTEMP,30,12,
     *        SINT,COST,SINTT,COSTT,NXI,NBRXI)
      CALL BR(ARG,M,PHIL,Q,DISA,DVARA,DTEMP,33,13,
     *        SINT,COST,SINTT,COSTT,NXI,NBRXI)
      DO 2 J=1,MT
      K1=2+J*2
      K2=12+J*2
      CALL BR(ARG,M,PHIL,Q,DISA,DVARA,DTEMP,K1,K2,
     *        SINT,COST,SINTT,COSTT,NXI,NBRXI)
      K1=K1+1
      K2=K2+1
      CALL BR(ARG,M,PHIL,Q,DISA,DVARA,DTEMP,K1,K2,
...
C     IF(IGH.EQ.0) STOP
      ...
      SUBROUTINE BR(ARG,M,PHIL,Q,DISA,DVARA,DTEMP,I,II,
     *              SINT,COST,SINTT,COSTT,NXI,NBRXI)
C     ==============
      IMPLICIT REAL *8(A-H,O-Z)
