	...
	dimension ddtaupl(ntot_)
	
!	dimension dkt(ntot_),dtaue(ntot_),dtaua(ntot_)

	double precision, allocatable, save :: dkt(:)
	double precision, allocatable, save :: dtaue(:)
	double precision, allocatable, save :: dtaua(:)

	allocate (dkt(ntot_))
	allocate (dtaue(ntot_))
	allocate (dtaua(ntot_))
...
c	--------------------------
	...
	call annuld(dkt,ntot_)
	call annuld(dtaue,ntot_)
