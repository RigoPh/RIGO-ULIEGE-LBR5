      ...
      implicit double precision(a-h,o-z)                                          pdi00020
...
c***********************************************************************pdi00100
      if(ier.eq.1) write(iu_11(iboat),*)' equation de degré 0 ?'                                          
      if(ier.eq.2) write(iu_11(iboat),*)' equation de degré >35 ? '                                           
      if(ier.eq.3) write(iu_11(iboat),19)                                         pdi00120
      if(ier.eq.4) write(iu_11(iboat),*)' coéf de equ(9)=0 '                                          
      if((ier.lt.0).and.(ier.gt.4)) write(iu_11(iboat),*)
     *' ier non valide =',ier                                        
      
	if(ier.eq.1) write(iu_14(iboat),*)' equation de degré 0 ?'							!bug                          
      if(ier.eq.2) write(iu_14(iboat),*)' equation de degré >35 ?'						!bug                                     
      if(ier.eq.3) write(iu_14(iboat),19)													!bug       
      if(ier.eq.4) write(iu_14(iboat),*)' coéf de equ(9)=0 '								!bug 	                           
      if((ier.lt.0).and.(ier.gt.4)) write(iu_14(iboat),*)
     *' ier non valide =',ier			!bug 
   ...
   22   write(iu_11(iboat),24) 
   	  write(iu_14(iboat),24)	                                                   pdi00180
        if=0                                                            pdi00190
        return                                                          pdi00200
   21   j=j+2                                                           pdi00210
   ...
   45   write(iu_11(iboat),46)                                                    pdi00320
        write(iu_14(iboat),46)
	  if=0                                                            !pdi00330
        return                                                          pdi00340
   28   m=m-1                                                           pdi00350
