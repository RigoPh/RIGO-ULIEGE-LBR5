	...
	use param_section, ONLY : iu_11,iu_14,iboat
...
cc normalize former matrix a and b.
      do i=1,n
        ...
        if (am.eq.0.0) then
          ...
          write(iu_11(iboat),*)' error 1 in subroutine recip, stop'
          write(iu_11(iboat),*)'  in equation n0',i,' amax=',am,'!!'
          write(iu_14(iboat),*)' error 1 in subroutine recip, stop'					!sept06		!bug
          write(iu_14(iboat),*)'  in equation n0',i,' amax=',am,'!!'				!sept06		!bug
		stop
        end if
        do j=1,n
          a(i,j)=a(i,j)/am
...
c       if large element is too small, print error and stop.
        if (dabs(am).lt.1.0e-15) then
          ...
          write(iu_11(iboat),*)' error 2 in subroutine recip, stop'
          write(iu_11(iboat),*)'  in equation n0',i,' pivot=',am,'!!'
          write(iu_14(iboat),*)' error 2 in subroutine recip, stop'					!sept06		!bug
          write(iu_14(iboat),*)'  in equation n0',i,' pivot=',am,'!!'				!sept06		!bug
		stop
        end if
