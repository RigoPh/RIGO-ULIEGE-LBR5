      subroutine carac2(e,a,b,c,d,v,f,g,h,o,p,q,z,sh,fam,
     *                  ksr,ksa,spec,po,phil,rayon,w,
     *                  delt,delt2,const2)

      use param_section,Z_=>Z,FAM_=>FAM,ITYPE_=>ITYPE,E_=>E,ETA_=>ETA,
     *SH_=>SH,A_=>A,CONST2_=>CONST2,B_=>B,SPEC_=>SPEC
...
c     calcul des poids du panneau
      specc=spec*w
      if(a.ge.0.00001) then
        paig2=((d*v+f*g)/a) * (rayon+kksa*d/2.)*phil*(pi/180.d00) *specc
      else
        paig2=0.0
      endif
      if(b.ge.0.00001) then
        praid2=((h*o+p*q)/b) * rayon*phil*(pi/180.d00) *specc
      else
        praid2=0.0
      endif
...
c     impressions de const
	if (impr2.ge.-1) then			!15.10.05		!sept2006
        write(iu_11(iboat),15)									!sept2006
        write(iu_11(iboat),11)(z(i),i=3,14)						!sept2006
