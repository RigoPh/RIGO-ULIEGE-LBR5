...
c  ordre des var. dans aux  (w=1 u=3 my=5 ny=7 nyx=9 ry=11 v =13  wø=15) 
      ...
      call matr(15,3,  1,k,aux,zb)           ! wø(0)
      call matr(16,3,ipt,k,aux,zb)           ! wø(yo)
      if(impr.eq.1) then
		write(iu_11(iboat),*) 
		write(iu_11(iboat),*) 'panneau nø',nel,' variable nø',kk
		write(iu_11(iboat),*) '+++++++++++++++++++++++++++++++++'
		write(iu_11(iboat),*) 
...
c     =========================================================
      ...
      write(iu_11(iboat),*) 
      write(iu_11(iboat),*) 
     *'(da/dx) et (db/dx) après subr angle - panneau nø',nel
      write(iu_11(iboat),*) 
     *'----------------------------------------------------'
      do 101 i=1,16
...
c     ===========================================================================
      ...
      if(impr.eq.1) then
		write(iu_11(iboat),*) '(da/dx) et (db/dx) après rang2'
		do 102 j=1,ne
		write(iu_11(iboat),*)
...
c zsn     = vect. solution(n,is)  car 1 colonne chaque cas de charge is 
   ...
   10 continue
      if(impr.eq.1) then
      do 19 is=1,nsol
        write(iu_11(iboat),*) 'cas de charge nø',is !fff
...
c     (le résultat est placé dans dzsn, b1 servant de vecteur de travail)
   ...
   13 	 continue
      if(impr.eq.1) then
        ...
        write(iu_11(iboat),*)'---------------------'
        write(iu_11(iboat),*)'variable xi nø',ivar 
        do 104 nel=1,neto
      	j1=8*(nel-1)
          write(iu_11(iboat),*)'dzsn relatif au panneau nø',nel 
