      subroutine dhydro(arg,darg,m,xi,phil,q,disc,dvarc,dvarh,
...
c       8 : exp(-alpha q (2pi-(yo-y))) * sin (béta q (2pi-(yo-y)))
   ...
   4  if(dabs(teta).ne.90.) goto 5
    ...
    6 continue
      ...
      call rr(arg,darg,m,xi,q,disc,dvarc,dvarh, 2,1,
     *        jj,kk,sint,cost,sintt,costt,nxi,nbrxi,
     *        si,co,ex)
      call rr(arg,darg,m,xi,q,disc,dvarc,dvarh, 1,2,
     *        jj,kk,sint,cost,sintt,costt,nxi,nbrxi,
     *        si,co,ex)
      call rr(arg,darg,m,xi,q,disc,dvarc,dvarh,29,3,
     *        jj,kk,sint,cost,sintt,costt,nxi,nbrxi,
     *        si,co,ex)
      call rr(arg,darg,m,xi,q,disc,dvarc,dvarh,25,4,
     *        jj,kk,sint,cost,sintt,costt,nxi,nbrxi,
     *        si,co,ex)
      call rr(arg,darg,m,xi,q,disc,dvarc,dvarh,27,5,
     *        jj,kk,sint,cost,sintt,costt,nxi,nbrxi,
     *        si,co,ex)
      call rr(arg,darg,m,xi,q,disc,dvarc,dvarh,24,6,
     *        jj,kk,sint,cost,sintt,costt,nxi,nbrxi,
     *        si,co,ex)
      call rr(arg,darg,m,xi,q,disc,dvarc,dvarh,26,7,
     *        jj,kk,sint,cost,sintt,costt,nxi,nbrxi,
     *        si,co,ex)
      call rr(arg,darg,m,xi,q,disc,dvarc,dvarh, 3,8,
     *        jj,kk,sint,cost,sintt,costt,nxi,nbrxi,
     *        si,co,ex)
      call rr(arg,darg,m,xi,q,disc,dvarc,dvarh,35,9,
     *        jj,kk,sint,cost,sintt,costt,nxi,nbrxi,
     *        si,co,ex)
      call rr(arg,darg,m,xi,q,disc,dvarc,dvarh,38,10,
     *        jj,kk,sint,cost,sintt,costt,nxi,nbrxi,
     *        si,co,ex)
      call rr(arg,darg,m,xi,q,disc,dvarc,dvarh,31,11,
     *        jj,kk,sint,cost,sintt,costt,nxi,nbrxi,
     *        si,co,ex)
      call rr(arg,darg,m,xi,q,disc,dvarc,dvarh,30,12,
     *        jj,kk,sint,cost,sintt,costt,nxi,nbrxi,
     *        si,co,ex)
      call rr(arg,darg,m,xi,q,disc,dvarc,dvarh,33,13,
     *        jj,kk,sint,cost,sintt,costt,nxi,nbrxi,
     *        si,co,ex)
      do 2 j=1,mt
      k1=2+j*2
      k2=12+j*2
      call rr(arg,darg,m,xi,q,disc,dvarc,dvarh,k1,k2,
     *        jj,kk,sint,cost,sintt,costt,nxi,nbrxi,
     *        si,co,ex)
      k1=k1+1
      k2=k2+1
...
c      if(igh.eq.0) stop
      ...
      subroutine rr(arg,darg,m,xi,q,disc,dvarc,dvarh,i,ii,
     *              jj,kk,sint,cost,sintt,costt,nxi,nbrxi,
     *              si,co,ex)
      implicit double precision(a-h,o-z)
      dimension arg(8),disc(720),dvarc(33,9,16),dvarh(33,9,38),nxi(9)
...
c      write(iu_11(iboat),*)'t1,t2,t3,t4'
c      write(iu_11(iboat),'(6e14.7)')t1,t2,t3,t4
c      write(iu_11(iboat),*)'dt1,dt2,dt3,dt4'
c      write(iu_11(iboat),'(6e14.7)')dt1,dt2,dt3,dt4
c      write(iu_11(iboat),*)' c1, c2 =', c1,c2
...
c      write(iu_11(iboat),*)' temp2=',temp2
c      write(iu_11(iboat),*)' dvarh(ii,k,1)=',dvarh(ii,k,1)
...
c      write(iu_11(iboat),*)' dvarh(ii,k,6)=',dvarh(ii,k,6)
c      write(iu_11(iboat),*)' '
