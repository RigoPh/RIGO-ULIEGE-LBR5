     ...
     *                ms,cha,npts,by,si,co,ex)
      implicit double precision(a-h,o-z)
	integer*4 npts

      double precision lamb,ii
      dimension arg(8),a(720),b(11286),dish(1710),si(4),co(4),
     *          ex(4),y(21),cha(100,3),by(1710)
...
c***************************************************************************
      ...
      pi=2.d00*acos(0.d00)
      if(dabs(teta).ne.180.d00) goto 4
      cost=-1.
      sint=0.
      costt=-dcos(phil*pi/180.d00)
      sintt=-dsin(phil*pi/180.d00)
      goto 6
   4  if(dabs(teta).ne.90.) goto 5
      ...
      cost=0.
      sint=ii
      costt=-dsin(phil*pi/180.d00)*ii
      sintt=dcos(phil*pi/180.d00)*ii
      goto 6
    5 cost=dcos(teta*pi/180.d00)
      sint=dsin(teta*pi/180.d00)
      costt=dcos((teta+phil)*pi/180.d00)
      sintt=dsin((teta+phil)*pi/180.d00)
    6 continue
      do 11 i=1,m
