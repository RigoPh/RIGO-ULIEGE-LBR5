     ...
     *  disc(720),dvarc(33,9,16),dtemp(33,9,38),dvarh(33,9,38)
      ...
      dimension darg(8,9)
	dimension dcha(100,10,9),de(9),bz(1710),transp(33)   !!!juin06
...
c       8 : exp(-alpha q (2pi-(yo-y))) * sin (béta q (2pi-(yo-y)))
   ...
   4  if(dabs(teta).ne.90.) goto 5
    ...
    6 continue
      ...
      call ar(arg,darg,m,phil,q,disc,dvarc,dtemp, 2,1,
     *        sint,cost,sintt,costt,nxi,nbrxi,si,co,ex)
      call ar(arg,darg,m,phil,q,disc,dvarc,dtemp, 1,2,
     *        sint,cost,sintt,costt,nxi,nbrxi,si,co,ex)
      call ar(arg,darg,m,phil,q,disc,dvarc,dtemp,29,3,
     *        sint,cost,sintt,costt,nxi,nbrxi,si,co,ex)
      call ar(arg,darg,m,phil,q,disc,dvarc,dtemp,25,4,
     *        sint,cost,sintt,costt,nxi,nbrxi,si,co,ex)
      call ar(arg,darg,m,phil,q,disc,dvarc,dtemp,27,5,
     *        sint,cost,sintt,costt,nxi,nbrxi,si,co,ex)
      call ar(arg,darg,m,phil,q,disc,dvarc,dtemp,24,6,
     *        sint,cost,sintt,costt,nxi,nbrxi,si,co,ex)
      call ar(arg,darg,m,phil,q,disc,dvarc,dtemp,26,7,
     *        sint,cost,sintt,costt,nxi,nbrxi,si,co,ex)
      call ar(arg,darg,m,phil,q,disc,dvarc,dtemp, 3,8,
     *        sint,cost,sintt,costt,nxi,nbrxi,si,co,ex)
      call ar(arg,darg,m,phil,q,disc,dvarc,dtemp,35,9,
     *        sint,cost,sintt,costt,nxi,nbrxi,si,co,ex)
      call ar(arg,darg,m,phil,q,disc,dvarc,dtemp,38,10,
     *        sint,cost,sintt,costt,nxi,nbrxi,si,co,ex)
      call ar(arg,darg,m,phil,q,disc,dvarc,dtemp,31,11,
     *        sint,cost,sintt,costt,nxi,nbrxi,si,co,ex)
      call ar(arg,darg,m,phil,q,disc,dvarc,dtemp,30,12,
     *        sint,cost,sintt,costt,nxi,nbrxi,si,co,ex)
      call ar(arg,darg,m,phil,q,disc,dvarc,dtemp,33,13,
     *        sint,cost,sintt,costt,nxi,nbrxi,si,co,ex)
      do 2 j=1,mt
      k1=2+j*2
      k2=12+j*2
      call ar(arg,darg,m,phil,q,disc,dvarc,dtemp,k1,k2,
     *        sint,cost,sintt,costt,nxi,nbrxi,si,co,ex)
      k1=k1+1
      k2=k2+1
      call ar(arg,darg,m,phil,q,disc,dvarc,dtemp,k1,k2,
 ...
 156	continue
   ...
   1  dtemp(ii,k,j)=0.
      ...
      subroutine ar(arg,darg,m,phil,q,disc,dvarc,dtemp,i,ii,
     *              sint,cost,sintt,costt,nxi,nbrxi,si,co,ex)
      implicit real *8(a-h,o-z)
