      subroutine spepite2(obj,xi,width)	
      use sharedvar
      implicit real*8(a-h,o-z)
      dimension plot(neto),ptol(neto)                                           !redressage !septembre 2007
	dimension xi(9*neto)
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
	...
	read(302) deltacsc(i),deltar(i),vepaiss(i),			!extension neto
     *           vhac(i),veac(i),vlsc(i),vesc(i),vhar(i),vear(i),
     *		   vlsr(i),vesr(i),philsc(i),qsc(i),vdiffc(i)				!18.03.04
...
!	dcor3   ! epaisseur de corrosion pour lisses          !redressage !septembre 2007
	...
	mui=1
      call pepitemain2(width,totalstrait,mui)         !redressage !septembre 2007
...
****************************************************************************
****************************************************************************
      subroutine pepitemain2(width,totalstrait,mpix)        !redressage !septembre 2007
